...
if (mysqli_num_rows($result) > 0) {
    ...
    // Start the session and set login details
    session_start();
    $_SESSION['userlogin'] = $row['username']; // Assuming 'username' column exists
    $_SESSION['id'] = $row['id'];         // Store the user ID for profile editing and authorization demos
